...
public class ColumnBuilder
{
    ...
    public ColumnBuilder(in StoreObjectIdentifier storeObject, PropertyBuilder propertyBuilder)
    {
        ...
        InternalOverrides = RelationalPropertyOverrides.GetOrCreate(propertyBuilder.Metadata, storeObject);
    ...
    /// </summary>
    public virtual IRelationalPropertyOverrides Overrides => InternalOverrides;
    ...
    /// </summary>
    public virtual PropertyBuilder PropertyBuilder { get; }
    ...
    public ColumnBuilder HasColumnName(string? name)
    {
